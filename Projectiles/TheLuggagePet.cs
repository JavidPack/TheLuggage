...
namespace TheLuggage.Projectiles
{
	public class TheLuggagePet : ModProjectile
	{
		...
		public override void AI()
		{
			...
			TheLuggagePlayer modPlayer = player.GetModPlayer<TheLuggagePlayer>(mod);

			if (Main.player[projectile.owner].dead)
			{
				modPlayer.theLuggagePet = false;
				//   Main.player[projectile.owner].truffle = false;
			}
			if (modPlayer.theLuggagePet)
			{
